...
<section class="property">
    <div class="gallery">
        <div class="pic-border">
            <img src="${productTopImages[0].pathUrl}" id="big-show">
        </div>
        <div class="pic-ls" id="pic-ls">
            <C:forEach items="${productTopImages}" var="img" varStatus="vs">
                <img src="${img.pathUrl}" big-image="${img.pathUrl}" class="sm-image ${vs.count == 1?'selected':''}">
            </C:forEach>
        </div>
    ...
    <div class="detail">
        ...
        <%--<div class="service">--%>
            <%--<span class="left">${shop.shopName}</span>--%>


                <%--<span class="updown arrow-png">--%>
                        <%--<img src="${shop.shopLog}">--%>
                    <%--</span>--%>
